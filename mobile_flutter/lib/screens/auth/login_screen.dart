  ...
  Widget build(BuildContext context) => SizedBox(
    ...
    child: Stack(
      ...
      children: [
        ...
        Positioned(top: 60, left: 28,
          child: _CategoryBubble(icon: Icons.construction, label: 'VOIRIE', color: AppColors.voirie)),

        // Category bubble – Électricité (top-right offset)
        Positioned(top: 55, right: 80,
          child: _CategoryBubble(icon: Icons.bolt, label: 'ÉLECTRICITÉ', color: AppColors.electricite)),

        // Category bubble – Eau (bottom-left)
        Positioned(bottom: 48, left: 20,
          child: _CategoryBubble(icon: Icons.water_drop, label: 'EAU', color: AppColors.eau, size: 44)),

        // Category bubble – Environnement (bottom-right)
        Positioned(bottom: 44, right: 24,
          child: _CategoryBubble(icon: Icons.eco, label: 'ENVIRONNEMENT', color: AppColors.environnement, size: 44)),
        ...
        Center(
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              color: AppColors.primaryGreen,
              boxShadow: [
                BoxShadow(color: AppColors.primaryGreen.withOpacity(0.4),
...
class _CategoryBubble extends StatelessWidget {
  ...
  final Color color;
  final double size;
  const _CategoryBubble({required this.icon, required this.label,
    required this.color, this.size = 48});
